    ...
    >
      ...
      <ul className="menu-inner py-1">
        ...
        <li className="menu-item">
          <a className="menu-link menu-toggle" onClick={openPaitient}>
        ...
        <li className="menu-item">
          <a className="menu-link" onClick={openPaitient}>
            <i className="menu-icon tf-icons bx bx-crown"></i>
            <div data-i18n="Boxicons">Add Patient</div>
          </a>
        </li>

        <li className="menu-item">
          <a href="javascript:void(0)" className="menu-link" onClick={addUser}>
            <i className="menu-icon tf-icons bx bx-crown"></i>
            <div data-i18n="Boxicons">Add User</div>
          </a>
        </li>

        <li className="menu-item">
          <a onClick={addAppointment} className="menu-link">
            <i className="menu-icon tf-icons bx bx-crown"></i>
            <div data-i18n="Boxicons">Add Appointment</div>
          </a>
        </li>

        <li className="menu-item">
          <a onClick={logout} target="_blank" class="menu-link">
